...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService("AuthService", "auth-service",
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "pFivQ2snfBF3XrOJMadvRXWVI21RFTzajuXCOlr8Q0k="));
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports,
        ...
        if(db != null) {
            ...
            envVars.put("SPRING_DATASOURCE_PASSWORD", Objects.requireNonNull(db.getSecret()).secretValueFromJson("admin").toString());
